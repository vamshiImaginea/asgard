  ...
  <div class="body">
    ...
    <div class="buttons">
      <g:form>
        ...
        <g:else>
          <g:link class="create" controller="security" action="create" params="[id:name]">Create Security Group</g:link>
        </g:else>
      </g:form>
    </div>
    <div class="dialog">
      <table>
        ...
        <tr class="prop">
          ...
          <td><g:link controller="instance" action="list" id="${name}" class="instance"
                      title="Show running instances of this app">Running Instance List</g:link></td>
        </tr>
        <tr class="prop">
          <td class="name">Images:</td>
          <td><g:link controller="image" action="list" id="${name}" class="image"
